  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-5xl flex-col gap-8 px-6 py-12 lg:px-10">
      <section className="rounded-[28px] border border-slate-200 bg-white/90 p-8 shadow-xl shadow-slate-200/80">
        <p className="text-sm uppercase tracking-[0.35em] text-teal-700">SSR · Permission-aware view</p>
        <h1 className="mt-3 text-4xl font-semibold tracking-tight text-slate-900 md:text-5xl">Profile overview</h1>
        <p className="mt-3 text-slate-600">This profile view is rendered dynamically to reflect the current session and permission context. It demonstrates how SSR can power user-specific detail panels with the same polished presentation as the rest of the app.</p>
        <p className="mt-3 rounded-2xl bg-slate-50 p-3 text-sm text-slate-700">Architecture use: SSR, role-context rendering, dynamic server data, and permission-aware presentation logic.</p>
